...
public class EnterPinActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvpintitle.setText("Enter PIN");
        binding.btnForgotPIN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                goToActivityWithFinish(context,ForgotPinActivity.class,null);
            }
        });
        keypadFunction();
    }
